...
import { Brand, RouteButton } from "../../components/ui.jsx";
...
export function AdminConsole({ route, navigate }) {
...
function AdminHeader({ title, body, navigate }) {
