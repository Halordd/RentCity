...
import { PhoneAccount, PhoneBooking, PhoneMessages, PhonePayments } from "../app/MobileApp";
...
export function WebAppExperience({ route, navigate }: RoutedScreenProps) {
...
function WebAppDashboard({ navigate }: NavigateProps) {
...
function WebAppManage({ navigate }: NavigateProps) {
